...
class BEVDataModule(LightningDataModule):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.data_train: Optional[BevDataset] = None
        self.data_val: Optional[BevDataset] = None
        self.data_test: Optional[BevDataset] = None
    ...
    def setup(self, stage: Optional[str] = None) -> None:
        ...
        self.data_train = BevDataset(self.cfg_dataset, mode="train")
        self.data_val = BevDataset(self.cfg_dataset, mode="val")
        print("Created Val and Training dataset")
        if self.cfg_dataset.return_test:
            self.data_test = BevDataset(self.cfg_dataset, mode="test")
        else:
