...
from perception_bev_learning.models.builder import build_backbone
from mmdet.models import BACKBONES
from torchvision.utils import save_image
from perception_bev_learning.ops import feature_decorator
...
class RadarEncoder(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.pts_transformer_encoder = (
            build_backbone(pts_transformer_encoder)
            if pts_transformer_encoder is not None
            else None
        )
        self.pts_bev_encoder = (
            build_backbone(pts_bev_encoder) if pts_bev_encoder is not None else None
        )
        self.post_scatter = (
            build_backbone(post_scatter) if post_scatter is not None else None
        )
