...
from perception_bev_learning.ops import SparseBasicBlock, make_sparse_convmodule
from perception_bev_learning.ops import spconv as spconv
...
class SparseEncoder(nn.Module):
    ...
    def forward(self, voxel_features, coors, batch_size, **kwargs):
        ...
        if self.upsample_output is not None:
            spatial_features = nn.functional.interpolate(
                spatial_features,
                scale_factor=self.upsample_output,
                mode="bilinear",
                align_corners=True,
            )
