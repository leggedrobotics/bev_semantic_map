...
from perception_bev_learning.ops.spconv import SparseConv3d, SubMConv3d
from perception_bev_learning.models.utils.transformer import MultiheadAttention
...
def count_mha(m: Union[MultiheadAttention, nn.MultiheadAttention], x, y):
    ...
    batch_first = m.batch_first if hasattr(m, "batch_first") else False
    if batch_first:
