...
{
  Index operator()(const Device& d, tv::TensorView<const Index> indicesIn, tv::TensorView<Index> indicesOut,
...
{
  Index operator()(const Device& d, tv::TensorView<const Index> indicesIn, tv::TensorView<IndexGrid> gridsOut,
