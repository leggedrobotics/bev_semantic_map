...
class DatasetWriter:
    ...
    def add_static_dict_to_h5py(self, group, data_dict, str_list_max_length=50, str_max_length=50):
    ...
    def add_dict_to_h5py(self, group, data_dict):
        for k, v in data_dict.items():
            ...
            if k in group.keys():
                ...
                group.create_dataset(k, data=v[None], maxshape=maxshape, compression=self.compression)
