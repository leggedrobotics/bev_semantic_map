...
def test(cfg: DictConfig) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    """Test the model. Can additionally evaluate on a testset, using best weights obtained during
    training.
...
@hydra.main(version_base="1.3", config_path="../../cfg", config_name="train_anymal.yaml")
