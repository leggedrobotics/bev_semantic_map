...
from perception_bev_learning.lightning import LightningBEVMulti, LightningBEVMultiR
...
def train(cfg: DictConfig) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    model_pretrained: LightningModule = LightningBEVMultiR.load_from_checkpoint(
