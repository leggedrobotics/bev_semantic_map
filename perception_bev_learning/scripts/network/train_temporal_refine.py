...
from perception_bev_learning.lightning import LightningBEVTemporal, LightningBEVTemporalTruncated
...
def train(cfg: DictConfig) -> Tuple[Dict[str, Any], Dict[str, Any]]:
    ...
    model_pretrained: LightningModule = LightningBEVTemporalTruncated.load_from_checkpoint(
    ckpt_path)
