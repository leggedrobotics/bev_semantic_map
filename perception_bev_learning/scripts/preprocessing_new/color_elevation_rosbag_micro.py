...
output_bag_file = "/home/manthan/bev_cover/cover_micro_v2.bag"
...
def process_gridmap(msg):
    ...
    gridmap_data = convert_gridmap_float32(msg, ["elevation","elevation_color","wheel_risk_bev"])
    ...
    np_data[ele_abs_idx] = np_data[ele_abs_idx] - 0.5
...
with rosbag.Bag(output_bag_file, 'w') as outbag:
    for topic, msg, t in rosbag.Bag(input_bag_file).read_messages():
        ...
        if topic == '/crl_rzr/traversability_map/map_micro_instantaneous':
