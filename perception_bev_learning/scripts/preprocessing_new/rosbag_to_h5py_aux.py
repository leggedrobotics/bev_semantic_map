...
class BagToH5:
    ...
    def run(self):
        ...
        # Create an empty dictionary for storing the messages which are saved only once
        # This dictionary will be passed to write_to_h5 function if some data needs to be accessed
        # Example use case would be to access the camera info data in the image converter
        stored_once_info_dict = {}
                    ...
                    if str(self.topic_to_h5_keys[topic]) in stored_once_dict:
                        ...
                        if not stored_once_dict[self.topic_to_h5_keys[topic]]:
                            ...
                            if self.converters[
                                ...
                                stored_once_info_dict[self.topic_to_h5_keys[topic]] = msg
