...
class GTVisualization:
    def __init__(self, h5py_path, cfg_file):
        ...
        self.gridmap_key = "g_elevation_map_micro_dem"
        self.gridmap_nano_key = "g_traversability_map_micro"
    ...
    def get_gridmap_short_data(self, datum):
        sk = datum["sequence_key"]
        h5py_grid_map = self.h5py_file[sk][self.gridmap_nano_key]
        gm_idx = datum[self.gridmap_nano_key]
        ...
        # Crop to 128 x 128
        grid_map_data = center_crop(grid_map_data, (128, 128))
