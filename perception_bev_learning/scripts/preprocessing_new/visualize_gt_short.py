...
class GTVisualization:
    def __init__(self, h5py_path, cfg_file):
        ...
        self.gridmap_key = "g_elevation_map_short_dem"
    ...
    def convert_obs_to_colors(self, risk_map):
        ...
        observed_color = torch.tensor([251.0 / 255, 151.0 / 255, 39.0 / 255])
        obs_fut_color = torch.tensor([150.0 / 255, 36.0 / 255, 145.0 / 255]) 
        unobs_color = torch.tensor([67.0 / 255, 110.0 / 255, 176.0 / 255]) 
    ...
    def get_gridmap_short_data(self, datum):
        ...
        m_obs = grid_map_data[confidence_idx] > 0.5
